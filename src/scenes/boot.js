...
/*    game.sprites.hydro.newTank({X:200,altitude:400,tankWidth:110,tankHeight:300,curHeight:150})
    ...
    game.sprites.hydro.newTank({X:850,altitude:-600,tankWidth:200,tankHeight:0,curHeight:0})
    ...
    */
    ...
    game.sprites.hydro.newTank({X:200,altitude:10,tankWidth:100,tankHeight:150,curHeight:0})
    game.sprites.hydro.newTank({X:600,altitude:10,tankWidth:100,tankHeight:150,curHeight:0})
    game.sprites.hydro.newCombo([2,3])
    game.sprites.hydro.newValve({X:200,altitude:400,isOpen:0})
    game.sprites.hydro.newValve({X:400,altitude:400,isOpen:0})
    game.sprites.hydro.newValve({X:500,altitude:400,isOpen:0})
    game.sprites.hydro.newValve({X:700,altitude:400,isOpen:0})
    ...
    game.sprites.hydro.newPipe(['V2','D0'])
    game.sprites.hydro.newPipe(['V3','D1'])
    game.sprites.hydro.newPipe(['D0','T4'])
    game.sprites.hydro.newPipe(['D1','T5'])
